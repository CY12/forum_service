...
public class GlobalExceptionHandler {
    ...
    public Response request404(NoHandlerFoundException ex){
        System.out.println("404..NoHandlerFoundException");
        return resultFormat(404,ex);
    }
    ...
    public Response requestStackOverflow(StackOverflowError ex) {
    ...
    private <T extends Throwable> Response resultFormat(Integer code, T ex) {
        ex.printStackTrace();
